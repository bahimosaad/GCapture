...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/lead/compresstotiff.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">compressToTiff</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="compresstotiff.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="compresstotiff.asmx?op=compressFolder">compressFolder</a>
