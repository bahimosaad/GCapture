/*
 * $Id: MorenaCapabilitiesExample.java,v 1.7 2009/11/16 18:36:20 motovsky Exp $
 *
...
public class MorenaCapabilitiesExample extends JApplet
{
  ...
  private class HelpAction extends AbstractAction
  {
    ...
    public synchronized void actionPerformed(ActionEvent e)
    {
      ...
      JOptionPane.showMessageDialog(MorenaCapabilitiesExample.this, scrollPane, "Morena Capabilities Example", JOptionPane.INFORMATION_MESSAGE, logo);
    }
  }
  ...
  private class AboutAction extends AbstractAction
  {
    ...
    public synchronized void actionPerformed(ActionEvent e)
    {
      JTextArea textArea = new JTextArea(" Version: 0.6 Beta\n\n\n");
      textArea.setEditable(false);
      textArea.setBorder(BorderFactory.createEtchedBorder());
      textArea.append(" Contact:\n");
      textArea.append(" twain@gnome.sk\n");
      textArea.append(" www.gnome.sk\n");
      textArea.append(" Copyright (c) 2009 Gnome Ltd. All rights reserved.");
      ...
      JOptionPane.showMessageDialog(MorenaCapabilitiesExample.this, textArea, "Morena Capabilities Example", JOptionPane.INFORMATION_MESSAGE, logo);
    }
  }
...
//      Java 1.6 introduced a comfortable ImageIO.getWriterFileSuffixes() method.
  ...
  {
    JFrame frame = new JFrame("Morena Capabilities Example");
