...
public class ImageUtils {
    ...
    public static BufferedImage rotateImage(Image img, int degree) {
        BufferedImage bufImg =  ImageGenerator.createBufferedImage(img) ;
    ...
    public static BufferedImage tilt(BufferedImage image, double angle) {
        ...
        BufferedImage result = gc.createCompatibleImage(neww, newh,BufferedImage.TRANSLUCENT);
