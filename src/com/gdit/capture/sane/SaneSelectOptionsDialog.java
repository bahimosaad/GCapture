/*
 * $Id: SaneSelectOptionsDialog.java,v 1.2 2009/09/29 16:53:58 motovsky Exp $
 *
...
public class SaneSelectOptionsDialog extends JDialog implements ActionListener
{
  private CapabilityDialogs saneDialog;
  private Capabilities capabilities;
  private JPanel tabPanels;
  private Frame frame;

  public SaneSelectOptionsDialog(Frame frame, Capabilities capabilities, CapabilityDialogs saneDialog)
  {
    ...
    tabPanels.setBorder(BorderFactory.createTitledBorder(border, "Select from the following supported options", TitledBorder.CENTER, TitledBorder.TOP, newFont));
