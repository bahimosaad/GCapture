 ...
 * $Id$
 *
 * Copyright (c) 1999-2010 Gnome spol. s r.o. All Rights Reserved.
 *
...
{ Image image;
  ...
  System.err.println();
  try
  { int value=source.getSupportedPathCodeTypes();
    System.err.println("    getSupportedPathCodeTypes()->"+value);
  }
  catch (TwainException exception1)
  { System.err.println("    getSupportedPathCodeTypes()->Failed");
  }
