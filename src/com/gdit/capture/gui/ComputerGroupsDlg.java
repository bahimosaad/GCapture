...
import com.gdit.capture.entity.ComputersGroups;
 ...
 * @author bahy
 */
public class ComputerGroupsDlg extends javax.swing.JDialog {

    /** Creates new form GroupsGUI */
    public ComputerGroupsDlg(Computers computer, ComputersPanel parent, boolean modal) {
...
//            grousTable.getColumn(bundle.getString("delete")).setCellEditor(new ButtonEditor(this, new JCheckBox(), bundle));
    ...
    public void showUser() {
        ...
        txtComputerName.setText(computer.getName());
        //addBtn.setText(bundle.getString("edit"));
        Set<ComputersGroups> rgs = computer.getComputersGroupses();
        RolesHome rolesDao = new RolesHome();
        clearAllChkBoxes();
        for (ComputersGroups rg : rgs) {
...
//        jScrollPane2 = new javax.swing.JScrollPane();
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            Set computersGroups = new HashSet();
            for (int i = 0; i < chkList.size(); i++) {
                JCheckBox chk = chkList.get(i);
                if (chk.isSelected()) {
                    ComputersGroups rg = new ComputersGroups();
                    rg.setComputers(computer);
                    Groups group = groups.get(i);
                    rg.setGroups(group);
                    computersGroups.add(rg);
                }
            }
            computer.setComputersGroupses(computersGroups);
            dao.attachDirty(computer);
            dao.commit();
