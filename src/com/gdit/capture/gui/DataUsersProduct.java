...
/*
 * DataUsersProduct.java
 *
 * Created on May 18, 2011, 1:20:56 PM
 */
 ...
 * @author bahi
 */
public class DataUsersProduct extends javax.swing.JPanel {

    private DataTableModel model;
    private ResourceBundle bundle;
    private Locale locale;
    /** Creates new form DataUsersProduct */
    public DataUsersProduct(ResourceBundle bundle,Locale locale) {
        this.locale = locale;
        this.bundle = bundle;
        initComponents();
        init();
    ...
    public void init() {
        ...
        List<Object[]> data = dao.getUserStatiscs(0, "0");
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if (usersCombo.getSelectedItem().equals("")) {
            PatientsDocHome dao = new PatientsDocHome();
            List<Object[]> data = dao.getUserStatiscs(0, date);
            model = new DataTableModel(data);
            dataTable.setModel(model);
        } else {
            Users user = (Users) usersCombo.getSelectedItem();
            PatientsDocHome dao = new PatientsDocHome();
            List<Object[]> data = dao.getUserStatiscs(user.getId(), date);
            model = new DataTableModel(data);
            dataTable.setModel(model);
        }
    ...
    public static void main(String[] args) {
      ...
      //  frame.getContentPane().add(new DataUsersProduct());
