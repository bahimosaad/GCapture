...
//        pack();
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            if(txtComputerName.getText().trim().equals("")){
                JOptionPane.showConfirmDialog(this, bundle.getString("error.computer.name.required"));
                return;
            }
...
//            }
    ...
    private void txtComputerNameActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        try {
            // TODO add your handling code here:
            InetAddress address = InetAddress.getByName(txtComputerName.getText());
    ...
    private void compNameVauleChange(java.beans.PropertyChangeEvent evt)throws java.beans.PropertyVetoException {
        try {
            // TODO add your handling code here:
            InetAddress address = InetAddress.getByName(txtComputerName.getText());
            String ip = address.getHostAddress();
