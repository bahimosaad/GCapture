...
import com.gdit.capture.entity.RolesReps;
 ...
 * @author Bahi
 */
public class RoleCategoriesDlg extends javax.swing.JDialog {

    /** Creates new form GroupsGUI */
    public RoleCategoriesDlg(Roles role, RolesPanel parent, boolean modal) {
    ...
    private void init() {
        try {
            CategoryHome categoriesDao = new CategoryHome();
            chkList = new ArrayList<JCheckBox>();
            categories = categoriesDao.getAllCategory();
            for (Category category : categories) {
                chkList.add(new JCheckBox(category.getRep().getName()+"---"+category.getName()));
            }
            categoriesChkList.setListData(chkList.toArray());
            showCategory();
        } catch (Exception ex) {
            ex.printStackTrace();
        }finally{
    ...
    public void showCategory() {
        ...
        Set<RolesCategories> rcs  = role.getRolesCategorieses();
        clearAllChkBoxes();
        for (RolesCategories rc : rcs) {
            //Roles role = (Roles) rolesDao.findByName(rg.getRoles().getRoleName());
            JCheckBox ckBox = new JCheckBox(rc.getCategory().getRep().getName()+"--"+rc.getCategory().getName());
            ckBox.setSelected(true);
            int index = categories.indexOf(rc.getCategory());
            ckBox.setSelected(true);
    ...
    private void initComponents() {
        ...
        categoriesChkList = new CheckBoxList();
...
//        jScrollPane2 = new javax.swing.JScrollPane();
        ...
        jScrollPane1.setViewportView(categoriesChkList);
        jScrollPane1.setSize(400, 400);
        jLabel2.setText(bundle.getString("categories")); // NOI18N
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            Set roleCategeories = new HashSet();
            for (int i = 0; i < chkList.size(); i++) {
                JCheckBox chk = chkList.get(i);
                if (chk.isSelected()) {
                    RolesCategories rg = new RolesCategories();
                    rg.setRoles(role);
                    Category category = categories.get(i);
                    rg.setCategory(category);
                    roleCategeories.add(rg);
                }
            }
            role.setRolesCategorieses(roleCategeories);
            dao.merge(role);
             dao.commit();
            this.dispose();
        } catch (Exception ex) {
...
//    private javax.swing.JLabel jLabel3;
    ...
    private CheckBoxList categoriesChkList;
