 ...
 * @author bahy
 */
public class GroupRolesDlg extends javax.swing.JDialog {

    /** Creates new form GroupsGUI */
    public GroupRolesDlg(Groups group, GroupsGUI parent, boolean modal) {
        super((JFrame)parent.getFrame(), modal);
        try {
...
//            grousTable.getColumn(bundle.getString("delete")).setCellEditor(new ButtonEditor(this, new JCheckBox(), bundle));
    ...
    public void showUser() {
        ...
        Set<RolesGroups> rgs = group.getRolesGroupses();
     //   RolesHome rolesDao = new RolesHome();
        clearAllChkBoxes();
        for (RolesGroups rg : rgs) {
            ...
            int index = roles.indexOf(rg.getRoles());
            ckBox.setSelected(true);
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            for (int i = 0; i < chkList.size(); i++) {
                ...
                if (chk.isSelected()) {
                    RolesGroups rg = new RolesGroups();
                    rg.setGroups(group);
            ...
            group.setRolesGroupses(groupRoles);
            dao.merge(group);
           // dao.commit();
