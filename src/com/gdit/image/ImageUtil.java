...
public class ImageUtil {
    ...
    public static Image rotateImage(ImageIcon img,double degree){
        BufferedImage bufImg = toBufferedImage(img.getImage());
    ...
    public static void main(String[] args){
        try {
            Image img = ImageIO.read(new File("C:\\Users\\Bahi\\Downloads\\index.jpg"));
