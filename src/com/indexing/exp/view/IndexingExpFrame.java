 ...
 * @author ehab
 */
public class IndexingExpFrame extends javax.swing.JFrame {

    /** Creates new form IndexingUserFrame */
    public IndexingExpFrame() {
        preInitComponents();
        initComponents();
        postInitComponents();
    }
...
//        });
    ...
    private void setTexts() {
        ...
        updateBTN.setText(bundle.getString("index.update"));
    ...
    private void initComponents() {
        ...
        statusPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, statusPanelLayout.createSequentialGroup()
                .addComponent(statusLBL, javax.swing.GroupLayout.DEFAULT_SIZE, 869, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void treeValueChanged(javax.swing.event.TreeSelectionEvent evt) {//GEN-FIRST:event_treeValueChanged
        try {
            ...
            if (lastIndexedNode == null) {
                ...
                statusLBL.setText(RUNNING_CAPTURE.getName() + " \\ " + CURRENT_IMG.getCapture().getCapture().getName() + " \\ " + CURRENT_IMG.getName());
...
//            hideFieldsPanel();
    ...
    private void loadBatchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadBatchActionPerformed
        ...
        java.util.List<Capture> grands = dao.getExceptionBatches();
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        try {
            ...
            Set<Capture> docs = batch.getCaptures();
        ...
        try {
            ...
            if (RUNNING_CAPTURE != null) {
                ...
                for (Capture parent : RUNNING_CAPTURE.getCaptures()) {
                    ...
                    if (parent.getStatus() == CaptureStatus.INDEX_EXCEPTION) {
...
//    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new IndexingExpFrame().setVisible(true);
            }
        });
    }
