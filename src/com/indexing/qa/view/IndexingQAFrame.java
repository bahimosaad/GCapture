 ...
 * @author ehab
 */
public class IndexingQAFrame extends javax.swing.JFrame {

    /** Creates new form IndexingUserFrame */
    public IndexingQAFrame() {
        preInitComponents();
        initComponents();
        postInitComponents();
    }
...
//                            Logger.getLogger(IndexingUserFrame.class.getName()).log(Level.SEVERE, null, ex);
...
//        });
    ...
    private void setTexts(){
        ...
        exceptionBTN.setText(bundle.getString("index.exception"));
...
//    }
    ...
    private void initComponents() {
        ...
        exceptionBTN = new javax.swing.JButton();
            ...
            .addGroup(batchesDLGLayout.createSequentialGroup()
                ...
                .addGroup(batchesDLGLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(batchesDLGLayout.createSequentialGroup()
                        ...
                        .addComponent(openBatchBTN, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        exceptionBTN.setText("Exception");
        ...
        imagePanel.setViewportView(imgLBL);
    ...
    private void nextBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBTNActionPerformed
        ...
        if (TREE_COUNTER >= 0) {
            try {
                ...
                if (new_document != null && !new_document.equals(old_document)) {
                    DocumentDataHome ddh = new DocumentDataHome();
                    List<DocumentData> docFieldData = ddh.getDocumentDataByID(new_document.getId());
                    ...
                    //update to index finished
                    CaptureHome captureHome = new CaptureHome();
                    Capture batch = batchItem.getCapture();
                    new_document.setStatus(CaptureStatus.INDEX_FINISHED);
                    batch.setStatus(CaptureStatus.INDEX_FINISHED);
                    captureHome.updateCaptureState(new_document);
...
//            hideFieldsPanel();
    ...
    private void loadBatchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadBatchActionPerformed
        ...
        java.util.List<Capture> grands = dao.getIndexedBatches();
    ...
    private void exceptionBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exceptionBTNActionPerformed
        Capture document = CURRENT_IMG.getCapture().getCapture();
        Capture batch = document.getCapture();

        document.setStatus(CaptureStatus.INDEX_EXCEPTION);
        batch.setStatus(CaptureStatus.INDEX_EXCEPTION);

        CaptureHome captureHome = new CaptureHome();
        captureHome.updateCaptureState(batch);
        captureHome.updateCaptureState(document);

    }//GEN-LAST:event_exceptionBTNActionPerformed
...
//        fieldsPanel.add(addBTN);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new IndexingQAFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton exceptionBTN;
