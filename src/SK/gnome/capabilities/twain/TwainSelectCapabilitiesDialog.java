/*
 * $Id: TwainSelectCapabilitiesDialog.java,v 1.3 2009/09/29 16:53:57 motovsky Exp $
 *
...
import SK.gnome.capabilities.CapabilityDialogs;


public class TwainSelectCapabilitiesDialog extends JDialog  implements ActionListener
{
  private CapabilityDialogs capabilityDialog;
  private JPanel checkBoxPanel;
  private Capabilities capabilities;
  private Frame frame;
  
  public TwainSelectCapabilitiesDialog(Frame frame, Capabilities capabilities, CapabilityDialogs capabilityDialog)
  {
    ...
    mainContainerPanel.setBorder(BorderFactory.createTitledBorder(border, "Select from the following supported capabilities", TitledBorder.CENTER, TitledBorder.TOP, newFont));
    ...
    else if(e.getActionCommand().equals("PreferencesButton"))
    {
      class PreferencesOptionPane extends JPanel
      {
        ...
        public PreferencesOptionPane(boolean restartAfterPreview, int sleepTimeBeforeRestart)
        {
          ...
          restartAfterPreviewCheckBox = new JCheckBox("Restart after image preview");
          ...
          JLabel label=new JLabel("Sleep time before new start (miliseconds):  ");
      ...
      JOptionPane.showMessageDialog(frame,preferencesOptionPane, "Preferences", JOptionPane.INFORMATION_MESSAGE);
