/*
 * $Id: TwainActivity.java,v 1.4 2009/11/06 18:28:15 motovsky Exp $
 *
...
public class TwainActivity extends Capabilities
{
  ...
  public static final Hashtable<String, Hashtable<String, String>> twainConstants=new Hashtable<String, Hashtable<String, String>>();
  public static final Hashtable<String, Hashtable<String, String>> twainConstantsValues=new Hashtable<String, Hashtable<String, String>>();
  ...
  public TwainActivity(Component centerPanel, String sourceName)
  {
    this.centerPanel=centerPanel;
    this.sourceName=sourceName;
    
    openSaneSource(sourceName);
  ...
  private void openSaneSource(String sourceName)
  {
    try
    {
  ...
  public int showDialogWindow()
  {
    ...
    dialogWindow=new CapabilityDialogs(frame, this);
