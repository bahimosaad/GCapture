...
//	public final static String HOME_DIR = System.getProperty("user.home", ".")
    public final static String HOME_DIR ="C:/" + ".capture";
	...
	/** The used default server base directory. */
	public static final String SERVER_PASS_PHRASE = "JFS";
	...
	public static final boolean SERVER_SHUT_DOWN = false;
	...
	public final URL getResourceUrl(String key) {
		return getUrl(JFSConst.getInstance().getString("jfs.resource.base")
